...
const whitelist = [
  ...
  `Don't let that dopey smile deceive you... Churro's a master KFCKFCKFC chef!`,
  `Nommm... Oh hi, I'm just meditating on the meaning of KFCKFC.`,
  `Three guesses what's put that twinkle in those eyes! (Hint: it's KFC)`,
  ...
  'Sort Title Z-A',
  'All articles',
  'Learn basics of Kaspa Finance',
  'Learn how',
  'You might also like',
  'Chef’s choice',
  'Recommended Readings by Chefs',
  'Latest News about Kaspa Finance and more!',
]
