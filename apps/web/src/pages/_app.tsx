  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Cheaper and faster than Uniswap? Discover Kaspa Finance, the leading DEX on BNB Smart Chain (BSC) with the best farms in DeFi and a lottery for KFC."
        />
