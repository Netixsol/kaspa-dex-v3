...
const AuthVerifyPage = () => {
  ...
  const generateVerificationMessage = (address: string, nonce: string) => {
  ...
  const { mutate: storeSignature, isLoading: isLoadingStoreSignature } = useMutation({
  ...
  }, [oauthToken, oauthVerifier, address])
