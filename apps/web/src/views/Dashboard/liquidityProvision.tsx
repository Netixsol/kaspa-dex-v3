...
import { Flex, Heading, Text, Box, Button } from '@pancakeswap/uikit'
...
const LiquidityProvision = () => {
  ...
  const { maintain7DayLiquidity, maintain30DayLiquidity, overallLiquidity, rewards } = !isLoading ? data : {}
  return (
    <>
              ...
              <Flex justifyContent="space-between">
                ...
                <Flex width="45%" justifyContent="space-between">
                  ...
                  <Flex
                    ...
                    borderRadius="100%"
                    background={`#${
                      rewards?.initialLiquidity?.isInitiated && rewards?.initialLiquidity?.isGiven ? '1FD26F' : '45434D'
                    }`}
