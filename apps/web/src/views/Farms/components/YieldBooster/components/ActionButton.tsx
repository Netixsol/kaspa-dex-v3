...
const BoosterTooltip = () => {
  ...
  return (
    <>
      {t(
        `Boost multiplier is calculated based on the staking conditions from both Farms and fixed-term KFC syrup pool and will be automatically updated upon user actions.`,
      )}
      <LinkExternal
