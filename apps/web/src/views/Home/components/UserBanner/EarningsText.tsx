...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and KFC pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and KFC pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from KFC pool', data)
  }
