...
const bottomLeftImage = {
  ...
  attributes: [
    { src: 'bottom-left', alt: 'KFC card' },
    { src: 'green', alt: 'Green KFC card with up arrow' },
    { src: 'red', alt: 'Red KFC card with down arrow' },
    { src: 'top-right', alt: 'KFC card' },
  ],
}
