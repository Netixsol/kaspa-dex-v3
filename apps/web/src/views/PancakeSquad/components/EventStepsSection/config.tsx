  ...
  return [
    {
      ...
      bodyText: [t('You’ll need an active Kaspa Finance Profile to buy Minting Tickets and mint a Pancake Squad NFT!')],
      buttons: (
        <>
    ...
    },
    {
      ...
      title: t('Hold KFC'),
      bodyText: [t('Each NFT costs KFC to mint. Remember you also need BNB to cover transaction fees too!')],
      buttons: (
        <>
          <Button
            as="a"
