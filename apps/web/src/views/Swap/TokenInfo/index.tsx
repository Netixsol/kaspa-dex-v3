...
// import { Currency } from '@moonbase/sdk'
// import { AutoRow, Button, CircleLoader, CopyButton, Flex, RowBetween, Skeleton } from '@moonbase/uikit'
// import { CurrencyLogo } from 'components/Logo'
// import { Trans } from '@moonbase/localization'
// import { FaArrowLeft } from 'react-icons/fa'
// import { formatLongNumber, formattedNum } from './swapUtils'
// import { shortenAddress } from 'views/Info/components/InfoTables/NewPoolTable'
...
// const Tab = styled(Button)<{ isActive?: boolean; isLeft?: boolean }>`
//   display: flex;
//   justify-content: center;
//   align-items: center;
//   flex: 1;
//   background-color: ${({ theme, isActive }) => (isActive ? theme.colors.primary : theme.colors.backgroundAlt)};
//   padding: 4px;
//   font-size: 12px;
//   font-weight: 500;
//   border-radius: 999px;
...
// const BackIconWrapper = styled(FaArrowLeft)`
//   height: 20px;
//   width: 20px;
//   margin-right: 10px;
//   cursor: pointer;
...
//             <InfoRowValue>{loading ? <CircleLoader size="10px" /> : item.value}</InfoRowValue>
//           </InfoRow>
//         ))}
...
//           <AutoRow width="100%" gap="4px">
//             {selectedToken ? (
//               <>
//                 <CurrencyLogo currency={selectedToken} size="16px" />
//                 <InfoRowValue>{shortenAddress(selectedToken.address)}</InfoRowValue>
//                 <CopyButton text={selectedToken.address} tooltipMessage={''} tooltipTop={10} />
