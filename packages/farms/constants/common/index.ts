...
import { bscTestnetTokens, bscTokens, ethereumTokens, goerliTestnetTokens, kasplexTokens } from '@pancakeswap/tokens'
...
export const DEFAULT_COMMON_PRICE: Record<ChainId, CommonPrice> = {
  ...
  [ChainId.KASPLEX_TESTNET]: {
    [kasplexTokens.usdt.address]: '1',
    [kasplexTokens.usdc.address]: '1',
  },
  [ChainId.BSC_TESTNET]: {
