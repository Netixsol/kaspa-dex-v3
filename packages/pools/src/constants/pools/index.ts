...
import { pools as kasplexTestnetPools, livePools as kasplexTestnetLivePools } from './167012'
...
export const POOLS_CONFIG_BY_CHAIN = {
  ...
  [ChainId.KASPLEX_TESTNET]: kasplexTestnetPools,
...
export const LIVE_POOLS_CONFIG_BY_CHAIN = {
  ...
  [ChainId.KASPLEX_TESTNET]: kasplexTestnetLivePools,
} as PoolsConfigByChain<SupportedChainId>
