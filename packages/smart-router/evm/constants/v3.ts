...
export const MIXED_ROUTE_QUOTER_ADDRESSES = {
  ...
  [ChainId.KASPLEX_MAINNET]: '0x678Aa4bF4E210cf2166753e054d5b7c31cc7fa86',  // Todo Mainnet Addresss
  [ChainId.BSC_TESTNET]: '0xB048Bbc1Ee6b733FFfCFb9e9CeF7375518e25997',
  [ChainId.KASPLEX_TESTNET]: '0xFf8c8c67603a330FDAa005883366A61A1C161a8B',
} as const
...
export const V3_QUOTER_ADDRESSES = {
  ...
  [ChainId.KASPLEX_MAINNET]: '0xB048Bbc1Ee6b733FFfCFb9e9CeF7375518e25997',  // Todo Mainnet Addresss
  [ChainId.BSC_TESTNET]: '0xbC203d7f83677c7ed3F7acEc959963E7F4ECC5C2',
  [ChainId.KASPLEX_TESTNET]: '0x4fA48f27Dc9230276a1b9C40588cC73d5fa536Db', // TODO Fixed For Kasplex Please Verify
} as const
