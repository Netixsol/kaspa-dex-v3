...
const bunnyHeadMax = `"data:image/svg+xml,%3Csvg width='11' height='11' viewBox='0 0 11 11' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Ccircle cx='5.5' cy='5.5' r='4.5' fill='url(%23paint0_linear_541_14326)' stroke='white' stroke-width='2'/%3E%3Cdefs%3E%3ClinearGradient id='paint0_linear_541_14326' x1='10.6396' y1='11' x2='0.277752' y2='10.7924' gradientUnits='userSpaceOnUse'%3E%3Cstop stop-color='%230D9589'/%3E%3Cstop offset='1' stop-color='%232DFE87'/%3E%3C/linearGradient%3E%3C/defs%3E%3C/svg%3E%0A"`;
const bunnyHeadMain = `"data:image/svg+xml,%3Csvg width='24' height='24' viewBox='0 0 11 11' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Ccircle cx='5.5' cy='5.5' r='4.5' fill='url(%23paint0_linear_541_14326)' stroke='white' stroke-width='2'/%3E%3Cdefs%3E%3ClinearGradient id='paint0_linear_541_14326' x1='10.6396' y1='11' x2='0.277752' y2='10.7924' gradientUnits='userSpaceOnUse'%3E%3Cstop stop-color='%230D9589'/%3E%3Cstop offset='1' stop-color='%232DFE87'/%3E%3C/linearGradient%3E%3C/defs%3E%3C/svg%3E%0A"`;
const bunnyButt = ``;
